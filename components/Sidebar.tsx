...
import { LayoutDashboard, Bed, Calendar, Settings, LogOut, Sparkles, LogIn, UtensilsCrossed, Users, UserCog, Building, Shield } from 'lucide-react';
...
export default function Sidebar() {
  return (
    <aside className="w-64 bg-white shadow-lg p-6 flex flex-col justify-between">
      <div>
        <div className="text-2xl font-bold mb-10 text-indigo-600"></div>
        <nav className="space-y-2">
          ...
          {/* Commented out menu items - moved to bottom */}
          {/* <MenuItem 
            icon={<Bed size={20} />} 
            label="Rooms" 
            href="/rooms"
