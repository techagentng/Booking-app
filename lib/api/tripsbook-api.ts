...
class TripsBookAPI {
  ...
  private getMockCategories(): Category[] {
    return [
      ...
      { id: 'hotels', name: 'Hotels', icon: 'building', color: 'bg-[#F58220]', count: 450 },
  ...
  private getMockTrendingCategories(): TrendingCategory[] {
    return [
      { name: 'Hotels', change: '+23%', color: 'bg-[#F58220]', icon: 'building' },
  ...
  private getMockFeaturedServices(): FeaturedService[] {
    return [
      { title: 'Hotels', description: '12 nearby', icon: 'building', color: 'bg-[#F58220]', count: 12, image: 'https://picsum.photos/seed/hotel/80/80.jpg' },
