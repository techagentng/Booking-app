        ...
        >
          ...
          <div className="w-full bg-gray-200 rounded-full h-3 mb-8">
            <motion.div
              ...
              className="bg-gradient-to-r from-gtbank-primary to-gtbank-secondary h-3 rounded-full"
            />
          </div>
                ...
                >
                  ...
                  <div className="flex-shrink-0">
                    {isCompleted ? (
                      ...
                      <div className="w-12 h-12 bg-gtbank-primary rounded-full flex items-center justify-center">
