...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    const redirectTo = typeof router.query.redirectTo === 'string' ? router.query.redirectTo : '/dashboard';
        ...
        <div className="relative z-10 flex flex-col justify-center items-center p-12 text-center">
          <AnimatedWrapper variants={fadeInLeft} delay={0.3}>
            <h1 className="text-5xl font-bold mb-6">
              Welcome to{' '}
              <span style={{ color: 'var(--accent-primary)' }}>K-TECH Hotel Management System</span>
            </h1>
          </AnimatedWrapper>
          ...
          <AnimatedWrapper variants={fadeInLeft} delay={0.4}>
            ...
            >
              Experience a seamless hotel management experience with our modern, user-friendly platform.
            </p>
          </AnimatedWrapper>
        </div>
