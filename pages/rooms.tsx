...
export default function Rooms() {
  ...
  const [roomForm, setRoomForm] = useState<CreateRoomData>({
    ...
    room_type: 'Standard',
    floor: 1,
    capacity: 2,  // Changed from max_occupancy to capacity
    price_per_night: 100,
    bed_type: 'Queen',
    description: '',
    amenities: '{}'  // Added amenities as an empty JSON string
  });
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form
              onSubmit={async (e) => {
                ...
                if (!roomForm.room_number || !roomForm.room_type || !roomForm.floor || 
                    !roomForm.capacity || !roomForm.price_per_night || !roomForm.bed_type) {
                ...
                try {
                  ...
                  if (editingRoom) {
                    ...
                    await createRoom.mutateAsync(payload, {
                      onSuccess: () => {
                        toast.success('Room created successfully!', { position: 'top-right' });
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="capacity" className="block text-sm font-medium text-gray-700 mb-1 flex items-center">
