...
export default function InRoomTablet() {
  ...
  // Fetch data
  const { data: guestInfo, isLoading: loadingGuest, error: guestError } = useGetGuestInfo(ROOM_NUMBER);
          ...
          <div className="p-8">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="flex-1 px-6 py-4 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
              >
  ...
  if (guestError || !guestInfo) {
    // Extract error message from API response
    const errorMessage = (guestError as any)?.response?.data?.errors 
      || (guestError as any)?.response?.data?.message 
      || 'Unable to load guest information';
    
    const isNoReservation = errorMessage.toLowerCase().includes('no active reservation');
    
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-500 to-blue-600 flex items-center justify-center p-8">
        <div className="bg-white rounded-3xl p-10 text-center max-w-md shadow-2xl">
          <div className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 ${
            isNoReservation ? 'bg-amber-100' : 'bg-red-100'
          }`}>
            <AlertCircle className={`w-10 h-10 ${isNoReservation ? 'text-amber-500' : 'text-red-500'}`} />
          </div>
          <h2 className="text-2xl font-bold mb-3 text-gray-900">
            {isNoReservation ? 'No Active Reservation' : 'Room Not Found'}
          </h2>
          <p className="text-gray-600 mb-6">{errorMessage}</p>
          {isNoReservation && (
            <p className="text-sm text-gray-500">
              Please check in at the front desk to access room services.
            </p>
          )}
        </div>
      </div>
  ...
  if (currentPage === 'home') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-blue-600 to-pink-500 p-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-white mb-16">
            <div className="backdrop-blur-sm bg-white/10 rounded-3xl p-8 border border-white/20 flex items-center justify-between gap-6">
              <div className="flex-1 pointer-events-none">
                <h1 className="text-6xl font-extrabold mb-3 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-2 gap-8 mb-10">
            ...
            >
              ...
              <h3 className="text-3xl font-bold mb-3 text-gray-900 group-hover:text-blue-600 transition-colors">Hotel Info</h3>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="bg-white/95 backdrop-blur-lg border-b border-gray-200 sticky top-0 z-20 shadow-sm">
          <div className="flex items-center justify-between p-6">
            ...
            <h1 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent">Room Service Menu</h1>
            {cart.length > 0 && (
              <button
                onClick={() => setShowCart(true)}
                className="relative bg-gradient-to-r from-indigo-600 to-blue-600 text-white px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105"
              >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <button
                        ...
                        className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white px-5 py-2.5 rounded-xl hover:shadow-lg transition-all hover:scale-105 font-semibold"
                      >
