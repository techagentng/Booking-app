...
export default function StaffPortal() {
  ...
  // Timer for in-progress tasks - FIXED to prevent infinite calls
  useEffect(() => {
    // Only run timer if there are in-progress tasks
    ...
    }, 5000); // Slower interval - 5 seconds instead of 1 second
