...
export const reservationKeys = {
  ...
  recentActivity: () => [...reservationKeys.all, 'recent-activity'] as const,
};
...
export const useGetDashboardStats = () => {
  // DISABLED - This hook was causing infinite calls
  return {
    data: null,
    isLoading: false,
    error: null,
...
export const useGetRecentActivity = () => {
  return useQuery({
    queryKey: reservationKeys.recentActivity(),
    queryFn: async () => {
      const { data } = await axios.get('/reservations/recent-activity');
      return data.data as RecentActivityResponse;
    },
...
export const useCreateReservation = () => {
  ...
  return useMutation({
    ...
    onSuccess: (newReservation) => {
      ...
      queryClient.invalidateQueries({ queryKey: reservationKeys.recentActivity() });
...
export const useCheckinReservation = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['dashboard'] });
      queryClient.invalidateQueries({ queryKey: ['tablet'] });
    },
  });
};
